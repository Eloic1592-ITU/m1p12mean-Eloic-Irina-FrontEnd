...
@Component({
  selector: 'app-detailservicevehicule',
  imports: [FormsModule,CommonModule],
  templateUrl: './detailservicevehicule.component.html',
  styleUrl: './detailservicevehicule.component.css'
})
export class DetailservicevehiculeComponent implements OnInit {
  id: string | null = null;
